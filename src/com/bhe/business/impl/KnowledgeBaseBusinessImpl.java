...
public class KnowledgeBaseBusinessImpl extends BaseBusiness implements IKnowledgeBaseBusiness {
	...
	@Override
	public Map<String, Object> insertKnowledgeBase(Map<String, Object> dataMap) {
	...
	@Override
	public Map<String, Object> selectKnowledgeBaseList(Map<String, Object> dataMap) {
		Map<String, Object> reMap = new HashMap<String, Object>();
	...
	@SuppressWarnings("unchecked")
	@Override
	public Map<String, Object> selectKnowledgeBaseOne(Map<String, Object> dataMap) {
		Map<String, Object> reMap = new HashMap<String, Object>();
